...
public final class PracticeValidation {
    ...
    private static final String CANNOT_DO_THIS_WHILE_FOLLOWING = ChatColor.RED + "You can't do this while following someone! Type /unfollow to exit.";
    private static final String CANNOT_DO_THIS_IN_SILENT_MODE = ChatColor.RED + "You can't do this while in silent mode!";
    private static final String CANNOT_DO_THIS_WHILST_IN_TOURNAMENT = ChatColor.RED + "You can't do this whilst in the tournament!";
    ...
    private boolean isInSilentMode(Player player) {
        return player.hasMetadata("VanishedMode");
    }
