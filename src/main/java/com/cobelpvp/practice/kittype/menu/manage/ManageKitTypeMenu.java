package com.cobelpvp.practice.kittype.menu.manage;
...
import com.cobelpvp.practice.util.menu.BooleanTraitButton;
...
public class ManageKitTypeMenu extends Menu {
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        buttons.put(getSlot(0, 8), new Button() {
            ...
            public List<String> getDescription(Player player) {
                return ImmutableList.of(
                    ...
                    ChatColor.RED + "use /kits wipekits type " + type.getId().toLowerCase()
                );
            }
        ...
        buttons.put(getSlot(8, 0), new MenuBackButton(p -> new CmdPracticeAdmin.ManageMenu().openMenu(p)));
