...
import com.cobelpvp.practice.party.listener.PartyChatListener;
import com.cobelpvp.practice.party.listener.PartyItemListener;
import com.cobelpvp.practice.party.listener.PartyLeaveListener;
...
public final class PartyHandler {
    ...
    public PartyHandler() {
        Bukkit.getPluginManager().registerEvents(new PartyChatListener(), Practice.getInstance());
    ...
    /**
     * Checks if the player provided is at a party ({@link Party#isMember(UUID) would return true}
     * @param player the player to check
     * @return if the player provided is at a party
     */
     ...
     * @return the player's party, or null if the player is not at a party.
     */
     ...
     *          if the player was not at a party
     */
