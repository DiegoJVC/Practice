...
import com.cobelpvp.practice.util.menu.IntegerTraitButton;
...
public final class ManageSchematicMenu extends Menu {
    ...
    public Map<Integer, Button> getButtons(Player player) {
        ...
        buttons.put(23, new BooleanTraitButton<>(schematic, "FinalUHC Only", ArenaSchematic::setFinalUHCOnly, ArenaSchematic::isFinalUHCOnly, save));
