...
/**
 * Represents an arena schematic. See {@link com.cobelpvp.practice.match.arena}
...
public final class ArenaSchematic {
    ...
    /**
     * If this schematic can be only be used for FinalUHC matches
     * Some schematics are built for specifically FinalUHC fights
     */
    ...
    @Getter @Setter private MaterialData icon = new MaterialData(Material.PAPER);
